    ...
    for i, off in enumerate(offsets):
        ...
        if sec1 == sec2:
            ...
            if vig == 1:
                ...
                arrow_pos = p1 - direction * 2  # adjust distance to scene scale
            ...
            if fiver == 1:
                ...
                arrow_pos = p2 - direction * 2  # adjust distance to scene scale
...
def draw_atom_words_from_dict(words_list, words_dict, modifiers_dict=None, modifiers_to_apply=None,
    ...
    with redirect_stdout(buffer):
        if sector_labels is None:
            ...
            sector_labelsT = {1:"End",2:"Death",3:"Witchcraft",4:"Shamanism",5:"Druidism",6:"Ley"}
        ...
        for i in range(6):
            ...
            img_path_sector = sector_labelsOut.get(i+1)
            #if img_path_sector:
            ...
            for (word, info), angle in zip(words_in_group, angles):
                ...
                if glyph_path:
                    try:
                        ...
                        print(f"Error drawing glyph {glyph_path}: {e}")
        ...
        #print("EFFECTS:",df["To"],"-",df["Comment"].to_string(index=False))
        print("EFFECTS:")
