...
words_dict = {
    ...
    "Water Grapple":{"level":2,"section":4,"AP":1, "range":0, "rt": 4, "comment": "A tendril of water this is applied to initiate a Grapple on its target (only if s = 2,3,or 4).Use 2 × SPI instead of STR for appropriate checks.", "chann":2},
    #Enhancements: Master
