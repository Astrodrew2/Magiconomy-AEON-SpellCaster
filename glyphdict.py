...
words_dict = {
    ...
    #Enhancements: Novice
    "Virulence EN": {"level":6,"section":3,"AP":1, "range":2, "rt": 2, "comment": "When combined with the Glyph of Fragment, discern exactly how long it has been since the target died.", "chann":2, "over":5},
