...
words_dict = {
    ...
    "Ice w=1": {"level":1,"section":6,"AP":1, "range":10, "rt": 3, "comment": "You take away all of the energy within the Ley winds creating a thing of ice before you with the density of the weight (w) of the cast,Duration: long-lasting", "chann":2 },
    "Ice w=2": {"level":1,"section":6,"AP":1, "range":10, "rt": 3, "comment": "You take away all of the energy within the Ley winds creating a thing of ice before you with the density of the weight (w) of the cast,Duration: long-lasting", "chann":2 },
    "Ice w=3": {"level":2,"section":6,"AP":1, "range":10, "rt": 3, "comment": "You take away all of the energy within the Ley winds creating a thing of ice before you with the density of the weight (w) of the cast,Duration: long-lasting", "chann":2 },
    "Ice w=4": {"level":2,"section":6,"AP":1, "range":10, "rt": 3, "comment": "You take away all of the energy within the Ley winds creating a thing of ice before you with the density of the weight (w) of the cast,Duration: long-lasting", "chann":2 },
    "Ice w=5": {"level":3,"section":6,"AP":1, "range":10, "rt": 3, "comment": "You take away all of the energy within the Ley winds creating a thing of ice before you with the density of the weight (w) of the cast,Duration: long-lasting", "chann":2 },
    #"Shape Ice": {"level":1,"section":6,"AP":1, "range":2, "rt": 2, "comment": "You cut away at the Ley ice shaping it into your desired form as long as there is enough material to do so. Can only be added to Glyph of Ice. Duration: long-lasting", "chann":2 },
    #Master
    ...
    "Soul Vessel (create)": {"level":2,"section":1,"AP":2, "range":5, "rt": 3, "comment": "Using the End winds combine 3 bloodstones into a soul vessel", "chann":2},
     ...
     "Soul Vessel (resurrect)": {"level":5,"section":1,"AP":5, "range":2, "rt": 2, "comment": "Use the Vigor within a Soul Vessel to Resurrect the Vigor’s previous owner. They are revived with the total Vigor within the Soul Vessel .", "chann":2},
    #Enhancements: Novice
    #Enhancements: Adept
    ...
    #"Crystal Grove EN": {"level":1,"section":1,"AP":1, "range":10, "rt": 6, "comment": "Splits Glyph of Crystal into an area covering 10ft radial crystal shards", "chann":2, "over": 1 },
    #Enhancements: Master
    ...
    #Enhancements: Master
    "Major Throw Earth EN": {"level":4,"section":4,"AP":1, "range":10, "rt": 3, "comment": "Throw an object of earth,within range, that is loose or suspended with a tremendous size (such as with Glyph of Earth(s=4))up to 10 ft away, dealing the specified thrown damage.", "chann":2,"over": 1 },
    ...
    #Adept:
    "Virulence": {"level":6,"section":3,"AP":1, "range":0, "rt": 0, "comment": "Reduce the max duration of a Curse to ⅕ of the original as a hard limit. E.g. If the Duration was 25 days it now becomes 5 days.", "chann":2,"over": -1 },
    "Chronic": {"level":1,"section":3,"AP":1, "range":0, "rt": 0, "comment": "Change the Duration of a curse to be Permanent. E.g. If the Duration was 5 days it now becomes Permanent.", "chann":2, "over":1},
    "Exacerbation": {"level":1,"section":3,"AP":2, "range":0, "rt": 0, "comment": "Instantly raise all Injury Levels to the next Level of a target when effected by a Curse. (IE. Crippled is now Destroyed)", "chann":2},
    "Radiation": {"level":1,"section":3,"AP":1, "range":0, "rt": 0, "comment": "A cursed target hit with this radiates their leaking Spirit outward reducing the Vigor of all mortals within 10ft around them by 20.", "chann":2, "over":1},
    #Enhancements: Adept
    #Master:
    "Fragment": {"level":1,"section":3,"AP":1, "range":2, "rt": 2, "comment": "Locate the Fragments of Eyr within a living creature. The target cannot have been dead for more than 10 days and they cannot be posthumously disfigured beyond the ability to function (e.g. decapitation).", "chann":2},
    "anAtomy": {"level":2,"section":3,"AP":2, "range":2, "rt": 2, "comment": "Discern the immediate effect of whatever killed a target. The target cannot have been dead for more than 10 days and they cannot be posthumously disfigured beyond the ability to function (e.g. decapitation).", "chann":2},
    "spiriT": {"level":2,"section":3,"AP":3, "range":2, "rt": 2, "comment": "When combined with the Glyph of Fragment, discern exactly how long it has been since the target died been since the target died by discerning the decay of the Soul.", "chann":2},
    ...
    #Enhancements: Novice
    #"Virulence EN": {"level":6,"section":3,"AP":1, "range":0, "rt": 0, "comment": "Reduce the max duration of a Curse to ⅕ of the original as a hard limit. E.g. If the Duration was 25 days it now becomes 5 days.", "chann":2,"over": -1 },
