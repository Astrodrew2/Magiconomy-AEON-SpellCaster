...
words_dict = {
    ...
    "Soul Vessel (create)": {"level":2,"section":1,"AP":2, "range":5, "rt": 3, "comment": "Using the End winds combine 3 bloodstones into a soul vessel", "chann":2},
     ...
     "Soul Vessel (resurrect)": {"level":1,"section":1,"AP":2, "range":2, "rt": 2, "comment": "Use the Vigor within a Soul Vessel to Resurrect the Vigor’s previous owner. They are revived with the total Vigor within the Soul Vessel .", "chann":2},
    #Enhancements: Novice
    #Enhancements: Adept
