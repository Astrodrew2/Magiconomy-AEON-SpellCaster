...
words_dict = {
    ...
    #Adept:
    "Virulence": {"level":6,"section":3,"AP":1, "range":2, "rt": 2, "comment": "Reduce the max duration of a Curse to ⅕ of the original as a hard limit. E.g. If the Duration was 25 days it now becomes 5 days.", "chann":2 },
    "Chronic": {"level":1,"section":3,"AP":1, "range":2, "rt": 2, "comment": "Change the Duration of a curse to be Permanent. E.g. If the Duration was 5 days it now becomes Permanent.", "chann":2},
    ...
    "Radiation": {"level":1,"section":3,"AP":1, "range":2, "rt": 2, "comment": "A cursed target hit with this radiates their leaking Spirit outward reducing the Vigor of all mortals within 10ft around them by 20.", "chann":2},
    #Enhancements: Adept
    #Master:
