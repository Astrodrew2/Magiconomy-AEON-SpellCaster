...
words_dict = {
    ...
    #Enhancements: Novice
    "Virulence EN": {"level":6,"section":3,"AP":1, "range":0, "rt": 0, "comment": "Reduce the max duration of a Curse to ⅕ of the original as a hard limit. E.g. If the Duration was 25 days it now becomes 5 days.", "chann":2},
