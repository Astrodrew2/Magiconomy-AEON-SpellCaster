...
mod_dict = {
    ...
    #Witchcraft
    "Ranged Curse": {"shape":"ripples","size":2,"appto":["Demise","Pestilence","Famine","Rage"],"AP":1, "energy":0, "comment": " With extra effort (adding 1AP) curses can now be cast at range at a point 20ft away"},
