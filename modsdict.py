...
mod_dict = {
    ...
    "Crystal Growth": {"shape":"double_diamond","size":2,"appto":["Crystal"],"AP":0, "energy":2, "comment": "Requires: Glyph of Crystal with beam range type Grows the initial crystal from the Crystal Glyph far enough outward up to the total range of the Glyph of Crystal away from you. If hit by the point of a growing crystal while it grows (during the initial cast), you will take 60 (Piercing) PD ⚔️/7 PP per 15ft of growth. If range is increased increase the damage by that multiple (e.g. 30ft range = 2x60 → 120 PD ⚔️/7 PP.). Add 2 Charge"},
