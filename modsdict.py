...
mod_dict = {
    ...
    "Shape Ice3": {"shape":"triangle","size":2,"appto":["Ice w=5"],"AP":0, "energy":1, "comment": "You cut away at the Ley ice shaping it into your desired form as long as there is enough material to do so." },
