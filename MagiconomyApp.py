...
if view_mode == "Spell Caster":
    ...
    st.write("Choose a **Books** to pick your Glyphs from. (These are the Books/Scrolls for which you access to get your glyphs from. For example, the Standard Book of Glyphs and/or the Book of Scrolls)")
